      ...
      <div id="sidebar-scrollbar">
          <nav class="iq-sidebar-menu">
              <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li>
                      <a href="#userinfo3" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span
                              class="ripple rippleEffect"></span><i class="las la-user-tie iq-arrow-left"></i><span>Nhân
                              viên
                          </span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                      <ul id="userinfo3" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                          <li><a href="{{route('users.index')}}"><i class="las la-id-card-alt"></i>Danh sách</a>
                          </li>
                      </ul>
                  </li>
                  </li>
                  <li>
                      <a href="#userinfo" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span
                              class="ripple rippleEffect"></span><i class="las la-user-tie iq-arrow-left"></i><span>Thể
                              loại</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                      <ul id="userinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                          <li><a href="{{route('categories.index')}}"><i class="las la-id-card-alt"></i>Danh sách</a>
                          </li>
                      </ul>
                  </li>
                  <li>
                  ...
                  <li>
                      ...
                      <ul id="ui-elements1" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                          <li><a href="{{route('customers.index')}}"><i class="las la-id-card-alt"></i>Danh sách</a>
                          </li>
                      </ul>
