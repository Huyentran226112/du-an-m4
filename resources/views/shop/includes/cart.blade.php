...
<br>
   <h1 style="text-align: center;width:100%" class="table table-hover table-condensed">GIỎ HÀNG</h1>
    ...
    <table id="cart" style="text-align: center;width:100%" class="table table-hover table-condensed">
            ...
            @foreach(session('cart') as $id => $details)
                ...
                <tr>
                    ...
                    <td data-th="Product">
                            ...
                            <img src="{{ 'public/assets/product/' . $details['image'] }}" width="100" height="100" class="img-responsive"/>
                            @else
                            không có ảnh
                            @endif
                    </td>
        ...
        <tfoot>
        <tr>
            <td><a href="{{ route('shop.index') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Tiếp tục mua sắm </a></td>
            @if (session('cart'))
